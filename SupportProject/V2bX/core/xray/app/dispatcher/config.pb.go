...
var file_config_proto_goTypes = []any{
	(*SessionConfig)(nil), // 0: rcon.core.app.dispatcher.SessionConfig
	(*Config)(nil),        // 1: rcon.core.app.dispatcher.Config
}
var file_config_proto_depIdxs = []int32{
	0, // 0: rcon.core.app.dispatcher.Config.settings:type_name -> rcon.core.app.dispatcher.SessionConfig
