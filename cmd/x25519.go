...
import (
	...
	"github.com/tavut846/Rcon/common/crypt"
...
func executeX25519() {
	...
	var publicKey []byte
	var yes, key string
	fmt.Println("è¦åŸºäºŽèŠ‚ç‚¹ä¿¡æ¯ç”Ÿæˆå¯†é’¥å—?(Y/n)")
	fmt.Scan(&yes)
	if strings.ToLower(yes) == "y" {
		var temp string
		fmt.Println("è¯·è¾“å…¥èŠ‚ç‚¹id:")
		fmt.Scan(&temp)
		key = temp
		fmt.Println("è¯·è¾“å…¥èŠ‚ç‚¹ç±»åž‹:")
		fmt.Scan(&temp)
		key += strings.ToLower(temp)
		fmt.Println("è¯·è¾“å…¥Token:")
		fmt.Scan(&temp)
		key += temp
